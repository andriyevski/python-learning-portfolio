# Homework from file tasks/8_8_User_album.md
## Task ## : 8.8
# 8_8_User_album
...
def make_album(name_artist: str, name_album: str, tracks: str | int) -> Dict:
    """
...
while True:
    print("\nTo exit write 'q'")
    artist_input_name = input("\nEnter 'Name of artist':")
    if artist_input_name.lower() == 'q':
        break
    album_input_name = input("\nEnter 'Album name':")
    if album_input_name.lower() == 'q':
        break
    track_input_name = input("\nEnter 'Name of track':")
    if track_input_name.lower() == 'q':
        break
    try:
        print(make_album(artist_input_name,album_input_name,track_input_name))
